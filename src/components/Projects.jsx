import { Shield, Activity, Box, Cpu, HardDrive, Network, Eye, ShieldAlert, Zap, Search, Terminal, Code, Bug } from 'lucide-react';
    ...
    <section id="projects" className="py-24 bg-black text-white border-t border-zinc-900">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid gap-20">
          ...
          {/* PROJECT 1: SPECTERFUZZER (API Security Fuzzer) */}
