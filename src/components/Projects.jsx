import { Shield, Activity, Share2, Box, Terminal, Cpu, HardDrive, Network, Eye, ShieldAlert, Zap } from 'lucide-react';
    ...
    <section id="projects" className="py-24 bg-black text-white border-t border-zinc-900">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid gap-20">
          ...
          {/* PROJECT 2: SENTINEL-PI IDS (IoT / Defense) */}
          ...
          {/* PROJECT 3: PI-DROP V1 (Hardware / Offensive) */}
          <div className="grid lg:grid-cols-2 gap-12 bg-zinc-900/20 border border-zinc-800 p-8 rounded-3xl group">
             <div className="space-y-6">
                <div>
